...
export default function Home() {
    ...
    return(
        <div className="font-mono bg-red-100 h-screen p-4 flex text-3xl justify-center items-center flex-col">
            <p className="font-normal italic text-center"><b>Note: </b>You will have 30s to answer each question. And, there will be 20 questions in total.</p>
